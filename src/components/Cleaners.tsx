      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16">
          ...
          <h2 className="font-display text-3xl font-extrabold tracking-tight text-zinc-950 sm:text-4xl">
            Элитные мастера чистоты ПрофКлининг
          </h2>
          <p className="mt-4 text-base sm:text-lg text-zinc-650 font-sans">
            Все наши клинеры проходят проверку службы безопасности, аттестацию
            по чек-листам Kärcher и регулярные медицинские осмотры. Вы можете
            бесплатно выбрать конкретного исполнителя.
          </p>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="relative aspect-square w-full overflow-hidden bg-zinc-100">
                  ...
                  >
                    <Heart
                      className={`h-4.5 w-4.5 ${isFav ? "fill-rose-500 text-rose-500" : "text-zinc-400 hover:text-rose-500"}`}
                    />
                  </button>
                </div>
                ...
                <div className="flex flex-1 flex-col p-5">
                  <div className="flex items-center space-x-1">
                    <span className="font-sans text-xs font-extrabold text-teal-600 bg-teal-50 px-2 py-0.5 rounded-md">
                      МСК Профи
                    </span>
                  ...
                  <div className="mt-3 grid grid-cols-2 gap-2 border-t border-zinc-100 pt-3 text-[11px] font-sans text-zinc-400">
                    <div>
                      <span className="block font-semibold uppercase tracking-wider text-[9px] text-zinc-400">
                        Опыт работы
                      </span>
                      <span className="mt-0.5 font-bold text-zinc-800">
                        {cleaner.experience}
                      </span>
                    </div>
                    <div>
          ...
          <div className="flex items-center space-x-3.5">
            ...
            <div>
              <h4 className="font-sans text-sm font-bold text-zinc-900">
                Индивидуальные пожелания к составу бригады?
              </h4>
              <p className="mt-1 text-xs text-zinc-550 leading-relaxed max-w-xl font-sans">
                Если у вас большой загородный коттедж (от 200 м²), мы бесплатно
                направим усиленную бригаду из 3-4 клинеров во главе с опытным
                бригадиром для контроля качества.
              </p>
            </div>
          </div>
        </div>
