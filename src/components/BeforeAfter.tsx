...
export default function BeforeAfter() {
  ...
  return (
    <section className="relative bg-transparent py-16 sm:py-24 z-10" id="before-after-section">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16">
          ...
          <p className="mt-4 text-base sm:text-lg text-slate-600 font-sans">
            Двигайте бегунок влево и вправо, чтобы оценить профессиональный результат весенней генеральной чистки от нашей команды.
          </p>
        </div>
        ...
        <div className="mt-12 grid grid-cols-1 gap-6 sm:grid-cols-3 max-w-4xl mx-auto">
          <div className="glass-panel p-5 rounded-3xl flex items-start space-x-3 hover:translate-y-[-2px] transition-transform duration-300">
            <span className="flex-shrink-0 h-8 w-8 rounded-full bg-rose-100 text-rose-600 flex items-center justify-center font-bold text-xs">ДО</span>
            <div className="text-left">
              <h4 className="font-sans text-sm font-bold text-slate-900">Запыленность и разводы</h4>
              <p className="mt-1 text-xs text-slate-500 font-sans leading-relaxed">Потускневший паркет, следы от пальцев на мебели, серый налет на зеркалах и скопления пыли в плинтусах.</p>
            </div>
          </div>
          <div className="glass-panel p-5 rounded-3xl flex items-start space-x-3 hover:translate-y-[-2px] transition-transform duration-300">
            <span className="flex-shrink-0 h-8 w-8 rounded-full bg-blue-100 text-blue-600 flex items-center justify-center font-bold text-xs">ПОСЛЕ</span>
            <div className="text-left">
              <h4 className="font-sans text-sm font-bold text-slate-900">Идеальный матовый блеск</h4>
              <p className="mt-1 text-xs text-slate-500 font-sans leading-relaxed">Кристально чистые стекла, очищенная эко-средствами мебель, тщательно вымытый и увлажненный воздух.</p>
            </div>
          </div>
          <div className="glass-panel p-5 rounded-3xl flex items-start space-x-3 hover:translate-y-[-2px] transition-transform duration-300">
            <span className="flex-shrink-0 h-8 w-8 rounded-full bg-blue-100 text-blue-600 flex items-center justify-center font-bold text-xs">⏳</span>
            <div className="text-left">
              <h4 className="font-sans text-sm font-bold text-slate-900">Экономия вашего времени</h4>
              <p className="mt-1 text-xs text-slate-500 font-sans leading-relaxed">В среднем вы экономите 4.5 часа личного времени, которое можете провести с близкими или посвятить любимому делу.</p>
            </div>
          </div>
        </div>
      </div>
