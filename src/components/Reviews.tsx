...
export default function Reviews() {
  ...
  return (
    <section
      className="bg-white py-16 sm:py-24 border-t border-zinc-100"
      id="reviews-section"
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-12 items-end mb-12 sm:mb-16">
          <div className="md:col-span-8 text-left">
            ...
            <p className="mt-4 text-base sm:text-lg text-zinc-650 font-sans max-w-2xl">
              Мы собираем обратную связь после каждого выполненного клининга.
              Прозрачная репутация и тысячи довольных семей в Москве и МО.
            </p>
          </div>
          ...
          <div className="md:col-span-4 flex flex-col items-start md:items-end justify-center space-y-3">
            <div className="flex items-center space-x-4 bg-zinc-50 p-4 border border-zinc-150 rounded-2xl">
              <div className="text-center">
                <span className="block font-display text-3xl font-black text-zinc-950">
                  {getAverageRating()}
                </span>
                <span className="text-[10px] uppercase tracking-wider font-extrabold text-zinc-400 font-sans">
                  Средняя оценка
                </span>
              </div>
              ...
              <div>
                ...
                <span className="text-xs text-zinc-550 font-sans mt-1 block">
        ...
        {showForm && (
          <div
            className="mx-auto max-w-xl bg-zinc-50 border border-zinc-150 rounded-3xl p-6 sm:p-8 mb-12 text-left shadow-lg animate-fade-in"
            id="review_form_container"
          >
            <h3 className="font-display text-lg font-bold text-zinc-900 mb-4">
              Написать отзыв о клининге ПрофКлининг
            </h3>

            <form onSubmit={handleReviewSubmit} className="space-y-4">
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div className="space-y-2">
                  <label className="block font-sans text-xs font-extrabold text-zinc-500 uppercase tracking-wider">
                    Ваше имя / Псевдоним
                  </label>
                  <input
                    type="text"
                ...
                <div className="space-y-2">
                  ...
                  >
                    <option value="Поддерживающая уборка">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center space-x-2">
                  {[1, 2, 3, 4, 5].map((s) => (
                    ...
                    >
                      <Star
                        className={`h-6 w-6 ${s <= rating ? "fill-amber-400 text-amber-400" : "text-zinc-300"}`}
                      />
                    </button>
                  ))}
        ...
        <div
          className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 text-left"
          id="reviews_logs_list"
        >
          {reviews.map((rev) => (
            <div
              key={rev.id}
                ...
                <div className="flex items-center justify-between">
                  ...
                  {rev.isVerified && (
                    <span className="flex items-center text-[10px] font-extrabold font-sans text-emerald-600 uppercase tracking-wider bg-emerald-50 px-2 py-0.5 rounded-full">
                      <BadgeCheck className="h-3 w-3 mr-1 stroke-[2.5]" /> Заказ
                      проверен
                    </span>
                  )}
                </div>
